...
│                         laptop_pricing_brl and configuration for tools like black
│
...
│
└── laptop_pricing_brl   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes laptop_pricing_brl a Python module
    │
